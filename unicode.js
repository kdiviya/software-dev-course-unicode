...
let codePointLast = inputString2.charCodeAt(5);
let swappedString =  String.fromCharCode(codePointLast) + inputString2.slice(1,5) + String.fromCharCode(codePointFirst); // Your code here
